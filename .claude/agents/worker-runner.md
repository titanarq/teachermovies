...
- The **backend**: one of the configured worktrees (qwen: ../teachermovies-qwen, claude: ../teachermovies-claude). If the caller did not say,
  ask — do not pick.
