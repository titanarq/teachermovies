...
class NsdServiceAnnouncerTest {
    ...
    @Test
    fun announceMovesToAnnouncingUntilThePlatformAnswers() =
        runTest {
    ...
    @Test
    fun successfulRegistrationReachesAnnouncedWithTheRegisteredName() =
        runTest {
            announcer.announce(INFO)
    ...
    @Test
    fun platformRenameSurfacesInRegisteredName() =
        runTest {
            announcer.announce(INFO)
    ...
    @Test
    fun registrationFailureReachesFailed() =
        runTest {
            announcer.announce(INFO)
    ...
    @Test
    fun announceWhileAnnouncedUnregistersBeforeRegisteringAgain() =
        runTest {
            announcer.announce(INFO)
            registrar.lastCallback.onRegistered(INFO.instanceName)
    ...
    @Test
    fun callbacksFromAReplacedRegistrationAreIgnored() =
        runTest {
            announcer.announce(INFO)
    ...
    @Test
    fun stopWhileAnnouncedUnregistersAndReturnsToIdle() =
        runTest {
            announcer.announce(INFO)
            registrar.lastCallback.onRegistered(INFO.instanceName)
    ...
    @Test
    fun invalidPortReachesFailedWithoutReachingTheRegistrar() =
        runTest {
    ...
    @Test
    fun throwingRegistrarReachesFailedInsteadOfPropagating() =
        runTest {
    ...
    @Test
    fun throwingUnregisterReachesFailedInsteadOfPropagating() =
        runTest {
            announcer.announce(INFO)
            registrar.lastCallback.onRegistered(INFO.instanceName)
