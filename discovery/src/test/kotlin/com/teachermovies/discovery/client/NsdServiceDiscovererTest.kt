...
class NsdServiceDiscovererTest {
    ...
    private class Collection(
        val emissions: MutableList<List<DiscoveredTv>>,
        val job: Job,
    )
    ...
    @Test
    fun collectingStartsTheBrowseForTheServiceType() =
        runTest {
    ...
    @Test
    fun foundThenResolvedServiceAppearsInTheList() =
        runTest {
            val c = collect()
    ...
    @Test
    fun losingAnUnresolvedServiceEmitsNothing() =
        runTest {
            val c = collect()
            browser.callback.onFound(TV_A.instanceName)
    ...
    @Test
    fun secondResolutionOfTheSameInstanceReplacesTheFirst() =
        runTest {
            val c = collect()
    ...
    @Test
    fun twoServicesComeOutSortedByName() =
        runTest {
            val c = collect()
    ...
    @Test
    fun resolutionFailureLeavesTheListUntouchedAndTheFlowOpen() =
        runTest {
            val c = collect()
            browser.callback.onFound(TV_A.instanceName)
            browser.callback.onResolved(TV_A)
    ...
    @Test
    fun startThrowingKeepsTheFlowOpen() =
        runTest {
    ...
    @Test
    fun cancellingTheCollectorStopsTheBrowseExactlyOnce() =
        runTest {
            val c = collect()
            browser.callback.onFound(TV_A.instanceName)
            browser.callback.onResolved(TV_A)
