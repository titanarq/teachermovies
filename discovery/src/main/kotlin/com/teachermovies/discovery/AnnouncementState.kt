...
sealed interface AnnouncementState {
    ...
    data class Announcing(val info: TvServiceInfo) : AnnouncementState
     ...
     */
    data class Announced(val info: TvServiceInfo, val registeredName: String) : AnnouncementState

    /** Announcing [info] failed, for the short human-readable [reason]. */
    data class Failed(val info: TvServiceInfo, val reason: String) : AnnouncementState
}
