...
sealed interface ParseResult {
    ...
    data class Parsed(val track: SubtitleTrack) : ParseResult

    /** No registered [SubtitleParser] handles a file with this [extension]. */
    data class Unsupported(val extension: String) : ParseResult
...
object SubtitleParsers {
    ...
    fun parse(file: File): ParseResult {
        val parser = parsers.firstOrNull { it.supports(file.name) }
