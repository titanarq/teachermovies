...
object SidecarSubtitles {
     ...
     */
    fun findFor(mediaFile: File, language: String = "en"): File? {
    ...
    private fun rankOf(name: String, base: String, lang: String, ext: String): Int? = when {
    ...
    private fun searchDirectories(mediaFile: File): List<File> {
        ...
        val subs = (parent.listFiles() ?: emptyArray())
